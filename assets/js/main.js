(function (factory) {
  ...
  .replace(/ /g, '.')}`;
	...
	document.addEventListener('DOMContentLoaded', () => {
		...
		const audioButton = document.querySelector('.l-single-audio');
		if (audioButton) {
		...
		if (!isHome) {
			document.querySelectorAll('#menu-header li a[href*="#"]').forEach(anchor => {
				anchor.parentElement.classList.remove('current-menu-item', 'current_page_item');
